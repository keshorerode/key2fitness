  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        style={{ fontFamily: 'var(--font-bebas)', fontSize: '1.7rem', letterSpacing: '0.05em', lineHeight: 1 }}
      >
        <span style={{ color: 'var(--tan)' }}>KEY</span>
        <span style={{ color: 'var(--white)' }}> 2 </span>
        <span style={{ color: 'var(--tan)' }}>FITNESS</span>
      </motion.div>
